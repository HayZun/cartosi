...
if (strlen($response) == 71) {
   ...
   echo Html::submit(_sx('button', 'Sauvegarder'), ['name'  => 'add','class' => 'btn btn-primary']);
    ...
    $req = $DB->query("INSERT INTO `glpi_plugin_cartosi_app` (`name`, `description`,`domain`,`leader`,`check`) VALUES ('$name','.L’Espace Courtier est.', '.DSI - INFORMATIQUE','Yoan BLAIN','2021-06-08')");
   }
}
